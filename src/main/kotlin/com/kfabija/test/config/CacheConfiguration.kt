...
class CacheConfiguration(
    ...
    fun cacheManagerCustomizer(): JCacheManagerCustomizer {
        return JCacheManagerCustomizer { cm ->
            createCache(cm, com.kfabija.test.repository.UserRepository.USERS_BY_LOGIN_CACHE)
            createCache(cm, com.kfabija.test.repository.UserRepository.USERS_BY_EMAIL_CACHE)
            createCache(cm, com.kfabija.test.domain.User::class.java.name)
            createCache(cm, com.kfabija.test.domain.Authority::class.java.name)
            createCache(cm, com.kfabija.test.domain.User::class.java.name + ".authorities")
